...
def parse_args():
  ...
  """
    ...
    parser.add_argument('--net', dest='net',
                        help='vgg16, res50, res101, res152, dense121, dense201',
...
if __name__ == '__main__':
    ...
    if args.net == 'vgg16':
        ...
        net = densenet(batch_size=cfg.TRAIN.IMS_PER_BATCH, num_layers=121)
    elif args.net == 'dense201':
        net = densenet(batch_size=cfg.TRAIN.IMS_PER_BATCH, num_layers=201)
